...
@Metadata(
        ...
        d2 = {"main", "", "args", "", "", "([Ljava/lang/String;)V", "operation", "op", "Lkotlin/Function0;", "production sources for module advancedkotlin"}
)
public final class InlineFunctionsKt {
    ...
    public static final void main(@NotNull String[] args) {
        ...
        String var2 = "This is the actual lambda operation";
        System.out.println(var2);
